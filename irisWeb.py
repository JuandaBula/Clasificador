# -*- coding: utf-8 -*-
"""
Created on Sat Sep 10 16:40:15 2022
...
lin_reg = joblib.load("https://github.com/JuandaBula/Clasificador/blob/main/lin_reg.pkl")

#with open('C:/Users/jdbul/OneDrive/Escritorio/Python/App_MachineLearning/log_reg.pkl', 'rb') as lo:
log_reg = joblib.load("https://github.com/JuandaBula/Clasificador/blob/main/log_reg.pkl")

#with open('C:/Users/jdbul/OneDrive/Escritorio/Python/App_MachineLearning/svc_m.pkl', 'rb') as sv:
svc_m = joblib.load("https://github.com/JuandaBula/Clasificador/blob/main/svc_m.pkl")
